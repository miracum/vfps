...
COPY --from=docker.io/bitnami/kubectl:1.29.3@sha256:f5fc0d561d9ef931f9ecb2e8b65d93eb92767c57f64897c56a100bfe28102c74 /opt/bitnami/kubectl/bin/kubectl /usr/bin/kubectl
