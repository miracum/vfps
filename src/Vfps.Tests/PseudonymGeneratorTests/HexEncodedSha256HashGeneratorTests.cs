...
public class HexEncodedSha256HashGeneratorTests
{
    ...
    [InlineData(
        "longer Value with an Emoji 👷‍♂️",
        "74B63BF6DC88DB9A3E54DC7EB2691749F50A3E6F04DC5D1F5EFE54D70EE21759"
    )]
    public void GeneratePseudonym_WithGivenInput_ShouldGenerateExpectedPseudonyms(
        string input,
    ...
    {
        sut.Invoking(s => s.GeneratePseudonym("test", 32)).Should().Throw<ArgumentException>();
    }
}
